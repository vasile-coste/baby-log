...
data class ImportedNotificationPreference(val enabled: Boolean, val avgDays: Int, val offsetMinutes: Int)
...
data class ImportedBabyData(
    ...
    val notificationPreference: ImportedNotificationPreference? = null,
)
...
data class ExportedBabyData(
    ...
    val notificationPreference: BabyNotificationPreference? = null,
)
