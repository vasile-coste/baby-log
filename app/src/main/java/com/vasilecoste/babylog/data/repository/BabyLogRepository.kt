...
import com.vasilecoste.babylog.data.db.dao.BabyNotificationPreferenceDao
...
class BabyLogRepository(
    ...
    private val babyNotificationPreferenceDao: BabyNotificationPreferenceDao,
    ...
    fun notificationPreference(babyId: Long): Flow<BabyNotificationPreference?> =
        babyNotificationPreferenceDao.getByBabyId(babyId)

    suspend fun setNotificationPreference(preference: BabyNotificationPreference) {
        babyNotificationPreferenceDao.upsert(preference)
    }
    ...
    suspend fun importBabyData(
        ...
        data.notificationPreference?.let { p ->
            babyNotificationPreferenceDao.upsert(
                BabyNotificationPreference(
                    babyId = babyId,
                    enabled = p.enabled,
                    avgDays = p.avgDays,
    ...
    suspend fun exportBabyData(babyId: Long): ExportedBabyData? {
        ...
        return ExportedBabyData(
            ...
            notificationPreference = babyNotificationPreferenceDao.getOnceByBabyId(babyId),
        )
    }
}
