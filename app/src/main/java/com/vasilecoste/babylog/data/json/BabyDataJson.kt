...
import com.vasilecoste.babylog.data.model.ImportedNotificationPreference
...
object BabyDataJson {
    ...
    fun parse(jsonText: String): ImportedBabyData {
        ...
        val notificationPreference = root.optJSONObject("notificationPreference")?.let { obj ->
            ImportedNotificationPreference(
                enabled = obj.optBoolean("enabled", true),
                avgDays = obj.optInt("avgDays", 2),
                offsetMinutes = obj.optInt("offsetMinutes", 10),
            )
        }
        ...
        root.put(
            ...
            data.notificationPreference?.let { p ->
                JSONObject()
                    ...
                    .put("avgDays", p.avgDays)
                    .put("offsetMinutes", p.offsetMinutes)
            },
        )
